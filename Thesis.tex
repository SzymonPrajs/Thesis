...
\title  {Search for Superluminous Supernovae in Large Surveys}
...
I, Szymon Prajs, declare that this thesis titled, `THESIS TITLE' and the work presented in it are my own. I confirm that:
...
\input{./Chapters/Chapter3} % Rate of SLSNe

\input{./Chapters/Chapter4} % Codes
