...
This thesis focuses on the photometric classification and the properties of superluminous supernovae (SLSN), as observed in large astronomical surveys. When working with large samples of transients and a limited spectroscopic follow-up campaign, photometric classifications are the only tool available to select objects which can subsequently be used to study their statistics properties including the rate and its evolution.

I begin by introducing the surveys which produce the transients archive used in this work. I discuss the effect of their properties and design on the work performed in this thesis. I also introduce the sources of auxiliary data, including the spectroscopic follow-up faculties as well as summarise the Dark Energy Survey (DES) spectroscopic sample of SLSNe.

Next, I develop a number of model and techniques used to simulate both core-collapse supernovae (CCSN) and SLSNe. I use the spin-down of a magnetar model in conjunction with spectroscopic UV absorption templates to build \textsc{SLAP}, a tool for simulating SLSN at any redshift, in any arbitrary photometric system. Similarly, I develop \textsc{CoCo} which can be used to simulate and generate the templates for CCSNe.
...
First of all I would like to sincerily thank my supervisor, Professor Mark Sullivan, for his fantastic support and mentorship over the last five years of my life. Having given me both the free
...
\input{./Chapters/Chapter2} % SNLS Rate

\input{./Chapters/Chapter3} % Codes

\input{./Chapters/Chapter4} % Rate of SLSNe

\input{./Chapters/Chapter5} % Machine Learning
