...
The combined training sample build in \sref{sec:AGNNoiseSN} is passed through the network using a batch size of 5000 objects with 100 epoch, or individual runs of the backpropagation algorithm. The best model, described in \sref{sec:AGNNoiseModel} converges rapidly on the accuracy of 99.7\% which vastly exceeded my expectations.
- Put in the ROC plot

\subsubsection{Selecting SNe}
- Pass all transients through the network
- I get 6000 objects which are most likely to be SN
