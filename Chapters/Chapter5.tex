...
Amonst the remaining sample of SLSNe candidates, 95 objects have an AAT spectroscopic redshift measurement. Combining this with the obsered light curves I selectec all objects with absulute luminosity, M $<$ -20 in the brightest photometric band and visually inspected the resulting sample to find find 19 objects that meet this criteria (\tref{tab:SLSNwithSpecZ}). Furthermore, I use the host galaxy photometric redshift estimates to select a further sample of seven candidates that meet the same criteria (\tref{tab:SLSNwithPhotZ}).
