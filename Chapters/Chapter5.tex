...
To build the SN classification model, I use the approach developed in \sref{sec:AGNNoiseModel} as the benchmark and work from that point modifying the network to suit the more delicate problem

- Used more colour filters
- Used tanh activation function because the differences were smaller
- Used absolute mags as another source of info  
