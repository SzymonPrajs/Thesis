...
Selecting the observing block is not as straight foward as to simply use the length of the shortest season. \fref{fig:ObsBlock} shows the cedance of DES in each season, field and band.

\begin{figure}
  \includegraphics{Figures/Chapter5/ObsBlock_Season1.pdf}
  \includegraphics{Figures/Chapter5/ObsBlock_Season2.pdf}
  \includegraphics{Figures/Chapter5/ObsBlock_Season3.pdf}
  \includegraphics{Figures/Chapter5/ObsBlock_Season4.pdf}
  \caption{}
  \label{fig:ObsBlock}
\end{figure}
