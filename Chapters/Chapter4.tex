...
--- This is mainly driven by the attempts to use Machine Learning for classification of SN in large surveys  

\subsection{CoCo}
- CoCo was written in C++ for performance reasons. We always
