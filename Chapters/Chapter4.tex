...
\begin{equation}
  F(t) = A \times [1 + B(t - {t_1})] \times \frac{e^{-\frac{t - t_{0}}{\tau_{fall}}}} {1 + e^{\frac{t - t_{max}}{\tau_{rise}}}}
\end{equation}
...
--- Talk about not being able to use all the photometry when the filters are close and overlap
