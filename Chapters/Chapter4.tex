...
In many way the package I have developed for simulating CCSN is very similar to \textsc{SLAP}, used for modelling SLSN. The performance aspect was again a critical part of the code design as we aim to similate millions of light curves in LSST and DES. This has lead to our decision to again follow the principle of developing the core of the package in \textsc{C++} and using \textsc{Cython} to create a \textsc{Python} front-end interface. From here on I will refer to the backend software as \textsc{CoCo} and the \textsc{Python} front-end as \text{pyCoCo}.
