...
Superluminous supernovae (SLSNe), defined as events with an absolute
magnitude brighter than $-$21 ($M<-21$), are a new puzzle in the study
of supernovae \citep{2012Sci...337..927G}. They appear 50-100 times
brighter than normal supernova events, and form at least two distinct
classes: SLSNe-II, which show signatures of interaction with
circumstellar material (CSM) via hydrogen and other lines
\citep{2007ApJ...659L..13O,2007ApJ...666.1116S,2011ApJ...735..106D},
and SLSNe-I (or SLSNe-Ic), which are hydrogen poor
\citep{2011Natur.474..487Q}.  While SLSNe-II may naturally be
explained as an extension of the fainter type IIn supernova events,
the power source behind SLSNe-I remains a subject of debate.
...
observed SLSN rate. Furthermore, if the strong preference for a young,
